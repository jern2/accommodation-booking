...
public class AccommodationBooking {
	 ...
	 public static void main(String[] args) {
	    ...
	    public static LocalDate selectDateFromCalendar(Set<LocalDate> reservedDates) {
	           LocalDate today = LocalDate.now();
	       ...
	       private static void displayCalendar(LocalDate calendarMonth, Set<LocalDate> reservedDates) {
			   ...
			   for (int day = 1; day <= daysInMonth; day++) {
				   ...
				   if (reservedDates.contains(currentDate)) {
					   // 빨간색: \u001B[31m, 초기화: \u001B[0m
					   System.out.printf("\u001B[31m%2d\u001B[0m\t", day); // 예약된 날짜 (빨간색)
				   } else {
					   // 초록색: \u001B[32m, 초기화: \u001B[0m
				   ...
				   if ((day + firstDayOfWeek) % 7 == 0) {
					   System.out.println("\t\t\t\t ║"); // 주말마다 오른쪽에 "║" 추가
					   if (day < daysInMonth) {
						   System.out.print("║\t\t\t"); // 다음 주 시작 시 왼쪽에 "║" 추가
					   }
				   }
			   }
