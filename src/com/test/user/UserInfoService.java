...
public class UserInfoService {
    ...
    // 사용자 정보 수정
    public boolean updateUserInfo(String newUserId, String newUserPassword, String newUserName, String newEmail, String newPhoneNum) {
        // 사용자 정보를 읽어옵니다.
        List<User> users = userService.readMemberFile();
        boolean isUpdated = false;

        for (User user : users) {
            if (user.getUserId().equals(newUserId) && user.getUserPassword().equals(newUserPassword)) { // userId로 비교
                // 사용자 정보를 업데이트합니다.
